...
func (c *CoreDNSEtcdProviderSolver) Present(ch *webhookapi.ChallengeRequest) error {
	...
	fmt.Printf("Add %s TXT=%s", service.Key, service.Text)
...
// concurrently.
func (c *CoreDNSEtcdProviderSolver) CleanUp(ch *webhookapi.ChallengeRequest) error {
...
func loadConfig(cfgJSON *extAPI.JSON) (CoreDNSEtcdProviderConfig, error) {
	...
	cfg := CoreDNSEtcdProviderConfig{Prefix: prefix}
